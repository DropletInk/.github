...
1. Always create [Pull Request(PR)](https://docs.github.com/en/issues/tracking-your-work-with-issues/linking-a-pull-request-to-an-issue) to resolve issue, never directly push in main branch.
...
2. There is one **default** branch in a repository from which the software is released. Always create a new branch from the **default** branch.
